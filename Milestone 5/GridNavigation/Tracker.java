  ...
  public void trackline() {
        ...
        while (black < steps) {
            ...
            if (leftEye.getLightValue() < (black_reading + blue_reading)/2 
                ...
                //pilot.travel(); //travel further to have lights pass marker
                pilot.travel(11, true);
                while(pilot.getMovement().getDistanceTraveled() < 5){ //Robot will go smoothly over intersection if going straight
                }
