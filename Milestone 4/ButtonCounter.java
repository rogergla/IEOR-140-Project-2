...
public class ButtonCounter {
     ...
     */
    void askXOrig() {
        LCD.drawString("Units: 0", 0, 2);
        int units = getInput(7);
        LCD.drawString("Tens: 0", 0, 3);
        int tens = getInput(7);
        LCD.drawString("Huns: 0", 0, 4);
        int hundreds = getInput(7);
        LCD.drawString("sign: 0", 0, 5);
        int sign = getInput(7);
        String _sign;
        if (sign == 1) {
            _sign = "+";
        ...
        LCD.clear(4);
        LCD.clear(5);
        LCD.drawString("X:" +_sign+hundreds+tens+units, 0, 2);
        this.x1 = sign*(hundreds*100+tens*10+units);
    }
